...
class DataDownloader:
    ...
    def zip_2_netcdf(self, name=str) -> None:
        ...
        try:
            with ZipFile(f"{DATA_DIR}{name}/historical_{name}.zip", "r") as zipObj:
                # Extract all the contents of zip file in current directory
                zipObj.extractall(f"{DATA_DIR}{name}/")
            print("Removing file:", f"{DATA_DIR}{name}/")
            os.remove(f"{DATA_DIR}{name}/historical_{name}.zip")
        except BadZipFile:

            # rename to netcdf
            print("Already nc...")
            print("Changing name: \n", f"{DATA_DIR}{name}/historical_{name}.nc")
            os.rename(
                f"{DATA_DIR}{name}/historical_{name}.zip",
                f"{DATA_DIR}{name}/historical_{name}.nc",
            )
...
def download_inmcm4():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_inmcm4.zip",
    )
...
def download_access1_0():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_access1_0.zip",
    )
...
def download_access1_3():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_access1_3.zip",
    )
...
#             "model": "bnu_esm",
#         },
#         f"{DATA_DIR}{name}/historical_bcc_csm1_1_m.zip",
#     )
...
def download_ipsl_cm5a_mr():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_ipsl_cm5a_mr.zip",
    )
...
def download_ipsl_cm5a_lr():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_ipsl_cm5a_lr.zip",
    )
...
def download_mpi_esm_lr():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_mpi_esm_lr.zip",
    )
...
def download_mpi_esm_mr():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_mpi_esm_mr.zip",
    )
...
def download_noresm1_m():
    ...
    c.retrieve(
        ...
        f"{DATA_DIR}{name}/historical_noresm1_m.zip",
    )
